...
Much like [VM Sandboxes](/learn/vm-sandboxes/overview), repositories are run in CodeSandbox VMs that enhance productivity and make overall development more accessible for developers of all levels.
